...
class NGramCollocationTable {
    ...
    getExpectedFrequencies(contingency) {
         ...
         *                                        TOTAL = n_all
         *
	 * We want the expected frequency of each cell in that table, so we need to
         * make 4 calculations. Informally, when you want the expected frequency of
         * cell (x,y), you do:
         *
     ...
     * cell in the expectedFrequencies table. It then sums these likelihoods and
...
class BiGramCollocationTable extends NGramCollocationTable {
    ...
    /**
     * Build a 2x2 contingency table for a given bigram. There are some strange-looking variables here, but they follow a pattern.  The first part, "n_" means "frequency of". The second part is made up of two characters, visually depicting the positions in the bigram.
     *
     ...
     * any word other than the word in second position". Concretely, for "big kahuna":
     *
