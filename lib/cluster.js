        ...
        function collapseNetworkClusters(collapseInto, otherClusters, cnCallback) {
            that.pool.query(`
                ...
                UPDATE network_cluster n1 SET
                    _text=(CASE n1._text WHEN NULL THEN '' ELSE n1._text||',' END)||STRING_AGG(n2._text, ',' ORDER BY n2.id ASC),
                    "text"=(CASE n1."text" WHEN NULL THEN '' ELSE n1."text"||',' END)||STRING_AGG(n2."text", ',' ORDER BY n2.id ASC),
                    text_tokenless=(CASE n1.text_tokenless WHEN NULL THEN '' ELSE n1.text_tokenless||',' END)||STRING_AGG(n2.text_tokenless, ',' ORDER BY n2.id ASC)
