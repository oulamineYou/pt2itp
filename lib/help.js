module.exports = function(argv) {
    switch (argv._[2]) {
        ...
        case ('dedupe'):
            ...
            console.log('');
            console.log('usage: index.js dedupe [--in-addresses=<FILE>] [--output <FILE>] [--tokens=<CODE, ...>]');
            console.log('                   [--hecate]');
            console.log('');
            console.log('Note: by default will read from STDIN and output to STDOUT');
            console.log('');
            console.log('[options]:');
            console.log('   --in-addresses=<FILE.geojson>   [optional] line-delimited geojson of address features');
