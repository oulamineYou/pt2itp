...
module.exports = function(argv) {
    switch (argv._[2]) {
        ...
        case ('debug'):
            ...
            console.log('');
            console.log('usage: index.js debug [--itp <ITP GeoJSON>] [--db <DATABASE>]');
            console.log('');
            console.log('[options]:');
            console.log('   --itp <ITP GeoJSON>             Generated ITP data');
            console.log('   --db  <DATABASE>                Database to use as a backend');
            break;
        case ('stat'):
            console.log('');
        ...
        case ('map'):
            ...
            console.log('                    [--error-network <FILE>] [--error-address <FILE>] [--post <cardinality>,...]');
            console.log('                    [--intersections] [--props <prop>,...] [--warn <FILE]');
            console.log('');
            console.log('[options]:');
