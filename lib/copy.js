    ...
    rl.on('line', (data) => {
        ...
        for (let feat of features) {
            ...
            if (opts.type === 'address') {
                ...
                rl.output.write(`${feat.properties.id}|${str(feat.properties.street)}|${str(feat.properties.streetTokenless)}|${str(feat.properties._text)}|${str(JSON.stringify(feat.geometry))}|${turf.lineDistance(feat.geometry)}\n`);
            }
        }
    });
}
