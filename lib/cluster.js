                ...
                that.pool.connect((err, client, pg_done) => {
                    ...
                    const processCursor = client.query(new Cursor(`
                        SELECT
                             ...
                             STRING_AGG(n2.text_tokenless, '|' ORDER BY n2.id ASC) AS cluster_text_tokenlesses,
                                ...
                                for (let row of rows) {
                                    ...
                                    for (let i = 0; i < cluster_ids.length; i++) {
                                        clusters.push({
                                            ...
                                            text_tokenless: cluster_text_tokenlesses[i],
					...
					text_tokenless: parentCluster.text_tokenless.split(',')[0]
				    }, clusters, true);
				    ...
				    for (let lr of linkerResult)
                                    ...
                                    for (let child of clusters) {
                                        ...
                                        if (processedIds.indexOf(child.id) === -1) {
                                            ...
                                            if ((geomOverlapPct > 0.95) && (textOverlapScore[child.id] > 70)) {
