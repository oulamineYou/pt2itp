    ...
    adoption(cb) {
        this.pool.query(`
            ...
            UPDATE address_cluster
                 SET name_uniqueness = a.cnt
                 FROM (SELECT COUNT(id) AS cnt FROM address_cluster GROUP BY _text) a;
            ...
            UPDATE address_cluster a
                ...
                WHERE o.orphan_adoptive_parent = a.id;

            DELETE FROM address_cluster
                WHERE id NOT IN (SELECT orphan_adoptive_parent FROM address_cluster WHERE orphan_adoptive_parent IS NOT NULL);
