                                ...
                                for (let ntext of row.n_name) {
                                    for (let atext of row.a_name) {
                                        ...
                                        if (['default', 'token'].indexOf(argv.name) !== -1) {
                                            ...
                                            ntext = diacritics(tokenize.main(tokenize.replaceToken(tokenRegex, ntext), meta.tokens, true)[tokenKey].join(' '));
                                            atext = diacritics(tokenize.main(tokenize.replaceToken(tokenRegex, atext), meta.tokens, true)[tokenKey].join(' '));
                                        }
