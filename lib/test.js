                            ...
                            for (let row of rows) {
                                ...
                                for (let ntext of row.n_name) {
                                    ...
                                    if (['default', 'token'].indexOf(argv.name) !== -1) {
                                        ...
                                        normalizedNtext = tokenize.replaceToken(tokenRegex, diacritics(tokenize(normalizedNtext, meta.tokens, true)[tokenKey].join(' ')));
                                        normalizedAtext = tokenize.replaceToken(tokenRegex, diacritics(tokenize(normalizedAtext, meta.tokens, true)[tokenKey].join(' ')));
