...
function isPass(query, pt, res, opts = {}, done) {
    ...
    // let cleanQuery = tokenize.replaceToken(tokenRegex, (tokenize.main(diacritics(query), opts.tokens)));
    ...
    // let matched = tokenize.replaceToken(tokenRegex, tokenize.main(diacritics(name), opts.tokens));
