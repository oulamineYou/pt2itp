    ...
    init(cb) {
        this.pool.connect((err, client, release) => {
            ...
            client.query(`
                ...
                DROP TABLE IF EXISTS address_unigrams;
                CREATE TABLE address_unigrams (word VARCHAR NOT NULL, frequency INTEGER, relative_frequency DOUBLE PRECISION);
                DROP TABLE IF EXISTS address_bigrams;
                CREATE TABLE address_bigrams (w1 VARCHAR NOT NULL, w2 VARCHAR NOT NULL, frequency INTEGER,likelihood_ratio DOUBLE PRECISION);
                CREATE INDEX ON address_unigrams (word);
                CREATE INDEX ON address_bigrams (w1, w2);

                DROP TABLE IF EXISTS network_unigrams;
                CREATE TABLE network_unigrams (word VARCHAR NOT NULL, frequency INTEGER, relative_frequency DOUBLE PRECISION);
                DROP TABLE IF EXISTS network_bigrams;
                CREATE TABLE network_bigrams (w1 VARCHAR NOT NULL, w2 VARCHAR NOT NULL, frequency INTEGER,likelihood_ratio DOUBLE PRECISION);
                CREATE INDEX ON network_unigrams (word);
                CREATE INDEX ON network_bigrams (w1, w2);
