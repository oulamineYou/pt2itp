...
function start(callback) {
	...
	console.log('**** diacritics ',diacritics(tokens.tokens.join(' ')));
	...
	console.log('#### feat.properties.street', feat.properties.street );
	console.log('#### feat.properties.streetTokenless', feat.properties.streetTokenless);
            ...
            if (opts.type === 'address') {
                ...
                rl.output.write(csv([[
                    ...
                    str(turf.lineDistance(feat.geometry))
                ]], {
                    delimiter: '|',
                    quote: String.fromCharCode(30)
                }));
