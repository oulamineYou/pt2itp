...
test('cluster.name', (t) => {
    ...
    popQ.defer((done) => {
        pool.query(`
            BEGIN;
            INSERT INTO network (text, _text, text_tokenless, id, geom) VALUES ('','','',1, ST_SetSRID(ST_GeomFromGeoJSON('{ "type": "LineString", "coordinates": [ [ -66.05180561542511, 45.26869136632906 ], [ -66.05007290840149, 45.268982070325656 ] ] }'), 4326));
            COMMIT;
        `, (err, res) => {
            t.error(err);
            return done();
    ...
    popQ.defer((done) => {
        pool.query(`
            ...
            INSERT INTO address (id, text, text_tokenless, _text, number, geom) VALUES (1, 'main st', 'main', 'Main Street', 10, ST_SetSRID(ST_GeomFromGeoJSON('{ "type": "Point", "coordinates": [ 0, 0 ] }'), 4326));
            INSERT INTO address (id, text, text_tokenless, _text, number, geom) VALUES (2, 'main st', 'main', 'Main Street', 10, ST_SetSRID(ST_GeomFromGeoJSON('{ "type": "Point", "coordinates": [ 0, 0 ]  }'), 4326));
            INSERT INTO address (id, text, text_tokenless, _text, number, geom) VALUES (3, 'main st', 'main', 'Main Street', 10, ST_SetSRID(ST_GeomFromGeoJSON('{ "type": "Point", "coordinates": [ 0, 0 ]  }'), 4326));
            INSERT INTO address (id, text, text_tokenless, _text, number, geom) VALUES (4, 'main st', 'main', 'Main Street', 10, ST_SetSRID(ST_GeomFromGeoJSON('{ "type": "Point", "coordinates": [ 0, 0 ]  }'), 4326));
            COMMIT;
        `, (err, res) => {
            t.error(err);
            return done();
...
test('cluster.address', (t) => {
    ...
    popQ.defer((done) => {
        pool.query(`
            BEGIN;
            INSERT INTO address (id, text, text_tokenless, _text, number, geom) VALUES (1, 'main st', 'main', 'Main Street', 10, ST_SetSRID(ST_GeomFromGeoJSON('{ "type": "Point", "coordinates": [-66.97265625,43.96119063892024, 1] }'), 4326));
            INSERT INTO address (id, text, text_tokenless, _text, number, geom) VALUES (2, 'main st', 'main', 'Main Street', 10, ST_SetSRID(ST_GeomFromGeoJSON('{ "type": "Point", "coordinates": [-66.97265625,43.96119063892024, 2] }'), 4326));
            INSERT INTO address (id, text, text_tokenless, _text, number, geom) VALUES (6, 'main st', 'main', 'Main Street', 10, ST_SetSRID(ST_GeomFromGeoJSON('{ "type": "Point", "coordinates": [-66.97265625,43.96119063892024, 6] }'), 4326));
            INSERT INTO address (id, text, text_tokenless, _text, number, geom) VALUES (3, 'main st', 'main', 'Main Street', 13, ST_SetSRID(ST_GeomFromGeoJSON('{ "type": "Point", "coordinates": [-105.46875,56.36525013685606, 3] }'), 4326));
            INSERT INTO address (id, text, text_tokenless, _text, number, geom) VALUES (4, 'main st', 'main', 'Main Street', 13, ST_SetSRID(ST_GeomFromGeoJSON('{ "type": "Point", "coordinates": [-105.46875,56.36525013685606, 4] }'), 4326));
            INSERT INTO address (id, text, text_tokenless, _text, number, geom) VALUES (5, 'fake av', 'fake', 'Fake Avenue', 10, ST_SetSRID(ST_GeomFromGeoJSON('{ "type": "Point", "coordinates": [-85.25390625,52.908902047770255, 5] }'), 4326));
            COMMIT;
        `, (err, res) => {
            t.error(err);
            return done();
...
test('cluster.collapse - substantial overlap (fail on length)', (t) => {
    pool.query(`
        ...
        INSERT INTO network (id, geom, network_length) VALUES (
            7,
            ST_SetSRID(ST_GeomFromGeoJSON('{"type":"LineString","coordinates":[[2,2],[4,2]]}'), 4326),
            2.0
        );
...
test('cluster.collapse - substantial overlap (fail on text)', (t) => {
    pool.query(`
        ...
        INSERT INTO network (id, geom, network_length) VALUES (
            7,
            ST_SetSRID(ST_GeomFromGeoJSON('{"type":"LineString","coordinates":[[2,2],[2.01,2]]}'), 4326),
            0.01
        );
...
test('cluster.collapse - substantial overlap (successful merge)', (t) => {
    pool.query(`
        ...
        INSERT INTO network (id, geom, network_length) VALUES (
            7,
            ST_SetSRID(ST_GeomFromGeoJSON('{"type":"LineString","coordinates":[[2,2],[2.001,2]]}'), 4326),
            0.001
        );
        INSERT INTO network (id, geom, network_length) VALUES (
            8,
            ST_SetSRID(ST_GeomFromGeoJSON('{"type":"LineString","coordinates":[[0.999,1],[1,1]]}'), 4326),
            0.001
        );
