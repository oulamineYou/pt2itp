...
function start(callback) {
    ...
    rl.on('line', (data) => {
        ...
        for (let feat of features) {
            ...
            } else if (Array.isArray(feat.properties.street) && feat.properties.street.lenth > 1) {
            ...
            for (let text of texts) {
                ...
                let tokens = tokenize.main(text._text, opts.tokens, true);
                text.text  = tokenize.replaceToken(tokenRegex, diacritics(tokens.tokens.join(' '))); // The street is standardized and it what is used to compare to the address cluster
            ...
            if (opts.type === 'address') {
                ...
                rl.output.write(csv([[
                    str(JSON.stringify(feat.properties.street)),
