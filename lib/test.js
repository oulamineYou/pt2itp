        ...
        index.getMeta(true, (err, meta) => {
            ...
            function matched() {
                ...
                client.query('SELECT count(*) FROM address WHERE netid IS NOT NULL', (err, res) => {
                    ...
                    const cursor = client.query(new Cursor('SELECT a._text, ST_AsGeoJSON(a.geom) AS geom FROM address a WHERE netid IS NOT NULL' + (argv.limit ? ' LIMIT ' + argv.limit : '') + ';'));
