...
test('Simple Buffer', (t) => {
    ...
    let fixture = require('./fixtures/buffer.simple.json');
    t.deepEquals(round(res), round(fixture));
    t.end();
});

test('Curved Buffer', (t) => {
    let res = buffer({
        type: 'LineString',
    ...
    let fixture = require('./fixtures/buffer.curved.json');
    t.deepEquals(round(res), round(fixture));
    t.end();
});

test('Self Intersection Buffer', (t) => {
    let res = buffer({
        type: 'LineString',
    ...
    let fixture = require('./fixtures/buffer.si.json');
    t.deepEquals(round(res), round(fixture));
    t.end();
});
